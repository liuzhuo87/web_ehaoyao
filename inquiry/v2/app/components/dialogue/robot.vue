<template>
    <div class="inquiry-robot dialog">
        ...
        <div class="diagnoseCard"
            ...
            <div @click.stop='clickDiagnoseCard' :data-id="stems.disease.id"
            ...
            <div class='freeback pad3 toShowMedical' @click.once='showMedication(stems)' id='inquiry_click_freeback'>
                <span class='icon-putaway'></span>
                查看用药方案
            </div>
        </div>
...
//                  this.$store.dispatch('setFinish',true);//点击灰掉并且不能触发事件
                if (commandid == 'start-doctor-inquiry') {
                    ...
                    this.$store.dispatch('setCurrentSort', 0)
