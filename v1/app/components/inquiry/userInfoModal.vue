        ...
        <div class="modalCont">
            ...
            <div class="tel inp-wrap" style="border-bottom:1px solid #eee;">
                ...
                <div class="inp" style="width:60%">
                    <input type="tel" maxlength="11" :value="userTel" @input="talChange" style="color:#666" placeholder="请输入手机号">
                </div>
            </div>
...
//            }
        ...
        methods: {
            ...
            beginAsk(){
                ...
                this.$store.dispatch('statisticApi',{eventName:'view_introduce',customData:['age='+userAge,'gender='+userGender,'tel='+userTel]});
